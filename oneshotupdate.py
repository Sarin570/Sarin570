...
print("\033[92m")
print(''' SSSSS   AAAAA    N     N   IIIII  RRRR        77777   00000
          S       A     A   NN    N    I    R   R           7   0   0
           SSS    AAAAAAA   N N   N    I    RRRR          777   0   0
              S   A     A   N  N  N    I    R  R        7       0   0
         SSSSS   A     A   N   N N   IIIII  R   R       7       00000
''')
time.sleep(2)
print('''"##################################                                              
          #       MADE BY SANIR_70         #
          ...
          # subescribe on youtube sanir_70 #
          #         copyright 2024         #
          ##################################''')
print("\033[91m")
